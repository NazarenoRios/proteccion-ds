...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-[#0033A0] text-white hover:bg-[#0B2987] focus:ring-[#3F66B3]',
    secondary: 'bg-[#E3E829] text-[#0033A0] hover:bg-[#FEFA6C] focus:ring-[#F5F548]',
    outline: 'border-2 border-[#0033A0] text-[#0033A0] hover:bg-[#EEF2F7] focus:ring-[#3F66B3]',
    ghost: 'text-[#0033A0] hover:bg-[#EEF2F7] focus:ring-[#3F66B3]',
  };
